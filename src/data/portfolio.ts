...
export const profile: Profile = {
  ...
  interests: [
    {
      label: "Research",
      value: "HCI, Human-AI Interaction, human-robot service interaction"
    },
    {
      label: "Methods",
      value: "Interactive systems, prototyping, product design, user-centered inquiry"
    },
    {
      label: "Applications",
      value: "Future interfaces, intelligent tools, everyday technology and behavior"
    }
  ],
  links: [
...
export const projects: Project[] = [
  {
    ...
    byline: "Chengran Xu",
    description:
      "An AI-assisted livestreaming companion system that uses real-time audience analysis, facial and voice monitoring, and foot-controlled interaction to help streamers reduce cognitive pressure and respond naturally during live performance.",
  ...
  },
  {
    ...
    byline: "Chengran Xu",
    description:
      "A self-guided drone system designed to enhance the efficiency of traffic surveillance and management in urban environments, providing real-time data and insights to city planners and traffic authorities.",
...
export const awards: Award[] = [
  {
    ...
    title: "Quest for Intelligence research initiative contributor",
    source: "People and Robots Lab",
    year: "2026"
  }
];

export const journeyGraph: JourneyGraph = {
  nodes: [
